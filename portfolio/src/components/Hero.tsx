...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Main hero content */}
      <div className="flex-1 flex items-center justify-center px-8 md:px-16 lg:px-24 pt-28 pb-0">
        <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Name */}
            <div ref={titleRef} className="hero-name mb-8 text-center lg:text-left">
